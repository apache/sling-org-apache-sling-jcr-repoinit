...
/** Test utilities */
public class U {
    public static boolean userExists(Session session, String id)
            throws LoginException, RepositoryException, InterruptedException {
    ...
    public static Session getServiceSession(Session session, String serviceId)
    ...
    public static boolean canWrite(Session session, String userId, String path)
     ...
     *  @throws PathNotFoundException if the path doesn't exist */
    public static boolean canRead(Session session, String userId, String path)
            throws PathNotFoundException, RepositoryException {
        if (!session.itemExists(path)) {
            throw new PathNotFoundException(path);
        }
    ...
    public static boolean hasProperty(Session session, String nodePath, String propertyName, Value propertyValue)
    ...
    public static boolean hasProperty(Session session, String nodePath, String propertyName, Value[] propertyValues)
            throws RepositoryException {
        final Node n = session.getNode(nodePath);
        if (n != null) {
            boolean isPropertyPresent = n.hasProperty(propertyName);
    ...
    public static boolean hasProperty(Authorizable a, String propertyName, Value propertyValue)
            throws RepositoryException {
        if (a != null) {
    ...
    public static boolean hasProperty(Authorizable a, String propertyName, Value[] propertyValues)
            throws RepositoryException {
        if (a != null) {
            boolean isPropertyPresent = a.hasProperty(propertyName);
            if (isPropertyPresent) {
